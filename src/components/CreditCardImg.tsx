...
interface CreditCardImgProps {
  cardNumber: string;
  expiry: string;
  cvv: string;
}

export const CreditCardImg = ({ cardNumber, expiry, cvv }: CreditCardImgProps) => {
  const [isFlipped, setIsFlipped] = useState(false);
  const [userName, setUserName] = useState<string | null>(null);

  useEffect(() => {
    setIsFlipped(!!cvv); // Flip when cvv has any value
    const storedUserName = localStorage.getItem("userName");
    setUserName(storedUserName || "CARDHOLDER NAME");
  }, [cvv]);
    ...
    <div className="flip-card">
      <div className="flip-card-inner">
        <div className="flip-card-front">
          ...
          <svg version="1.1" className="chip" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 50 50" xml:space="preserve">
